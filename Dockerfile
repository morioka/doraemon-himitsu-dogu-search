...
RUN curl -k -Lo analysis-sudachi-8.6.0-3.0.0.zip https://github.com/WorksApplications/elasticsearch-sudachi/releases/download/v3.0.0/analysis-sudachi-8.6.0-3.0.0.zip && \
    elasticsearch-plugin install file:/usr/share/elasticsearch/analysis-sudachi-8.6.0-3.0.0.zip && \
    rm -f analysis-sudachi-8.6.0-3.0.0.zip
